  ...
  return (
    <>
      <div className="p-[60px] bg-[#E9E9E9] max-w-[800px]">
        <div className="w-[75px] h-[75px] bg-[#080607] mx-auto mb-10 rounded-full flex justify-center items-center">
        ...
        <Link to="/login" className='bg-[#ED272C] py-[18px] px-[60px] text-[#fff] text-[16px] not-italic font-medium leading-6 text-center rounded-[5px] text-[#FFF] text-[16px] not-italic font-semibold leading-7'>Go to Log In</Link>
        </div>
      </div>
    </>
  )
